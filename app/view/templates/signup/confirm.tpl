{include file="include/header.tpl" title='ユーザー情報登録内容確認' systemRoot=$systemRoot}
    <div id="container">
      <h2 class="title-h2">ユーザー情報登録内容確認</h2>
      <ol class="step">
      ...
      <div class="col-base col-630">
        <p class="msg-info">以下の内容でユーザー情報を新規登録します。よろしいですか？</p>
