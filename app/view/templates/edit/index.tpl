{include file="include/header.tpl" title='ユーザー情報変更' systemRoot=$systemRoot gnav='inner' css_font='true'}
{include file="include/subcontents/gmenu.tpl" gcurrent="6"}
    <div id="container">
      <h2 class="title-h2">ユーザー情報変更</h2>
      <ol class="step">
      ...
      <div class="col-base col-630">
        <form method="POST" class="form form-table" enctype="multipart/form-data">
            ...
            <table class="table-responsive">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{$selectHtml}<span class="display_count_unit">件/1ページ</span>{$err_display_count}</td>
                </tr>
                <tr>
...
{include file="include/footer.tpl" systemRoot=$systemRoot user='true' slideMenu='inner'}