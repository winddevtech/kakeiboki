...
class TimelineController extends MainController  {
    ...
    public function displayAction() {
        ...
        $timeline_base = TimelineProc::getTimelineBase($contact_id);
        ...
        $icon_img = TimelineProc::getDisplayIcon($this->login_user_obj->getIconImg());

        // json出力
        $result_data = array(
                'status' => 'success',
                'timeline_list' => $timeline_list,
                'category_name' => Security::h($category_name),
                'user_icon' => $icon_img,
                'user_name' => Security::h($this->login_user_obj->getName()),
