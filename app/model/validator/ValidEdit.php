...
class ValidEdit {
    public static function valid($formObj){
        ...
        $rule = array (
                ...
                'size' => array(InputConst::USER_NAME_LENGTH_OVER, InputConst::USER_NAME_MAX_LENGTH)
        );
        ...
        if ($errMsg_pass != '') $formObj->addErrMsg('password', $errMsg_pass);
        ...
        if ($errMsg_passConf != '') $formObj->addErrMsg('password_conf', $errMsg_passConf);
