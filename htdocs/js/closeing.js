(function ( $ ) {
    $.fn.closeing = function (options){
        ...
        var html_h = '<thead class="list-head"><tr><th>借方残高</th><th>借方合計</th><th>勘定科目</th><th>貸方合計</th><th>貸方残高</th></tr></thead>';
        var html_b = '';
        ...
        $loadbox.fadeOut();
        $container.append('<table id="js-closeing" class="closeing list list-closeing">' + html_h + html_b + '</table>');
