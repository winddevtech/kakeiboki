'use strict'
$(function() {
    $('#wrapper').after('<div id="js-modal-overlay" class="modal-overlay"></div><div id="js-modal" class="modal modal-timeline"><div class="modal-contents"><p class="modal-form__title">返信内容を入力してください。</p><textarea rows="10" placeholder="返信内容を入力してください。" name="context" id="context" class="ctl-textarea"></textarea><div class="counterRow modal-form__counterRow">あと<span id="counter_context">1000</span>文字入力できます。</div></div><div class="btn-row btn-multi"><input type="button" value="キャンセル" class="btn" id="js-btn-cancel"><input type="submit" value="返信" class="btn" id="js-btn-reply"></div></div>');
